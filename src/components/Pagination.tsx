...
export default function PaginationCard() { // Экспортируем функциональный компонент AboutUs
  ...
  const [pageSize, setPageSize] = useState(10); // Используем состояние pageSize для хранения количества элементов на странице
  ...
  return (
    <div>
      <Pagination // Компонент пагинации Ant Design
        ...
        pageSizeOptions={[10, 20, 30, 40, 50]} // Опции изменения размера страницы
